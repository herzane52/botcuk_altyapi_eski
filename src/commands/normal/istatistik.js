// Discord.js modülünü ve istemci nesnesini tanımlayın
...
{
    name: "istatistik",
    aliases: ["i", "istatistik", "bot"],
    cooldown: 20000, // cooldown olmasını istemezseniz 0 yazın.
    run: async (client, message, args) => 
    {
        ...
        const freememMemory = os.freemem();
          ...
          if (percent == 0) {
            // Eğer yüzde sıfırsa
            //ful boş
            //<:bs:1195506612136321126>
            //<:bo:1195506609280004107>
            //<:bsg:1195506614455767090>
            //yarı
            //<a:ys:1195506626753462343> yarı boş sol
            //<a:yo:1195506625562280126>
            //<a:ysg:1195506630587076648>
            //full
            //<a:ds:1195506619530870784>
            //<a:do:1195506617966411907>
            //<a:dsg:1195506622596911154>
          ...
          if (percent2 == 0) {
            ...
            const dev = await message.client.users.fetch("705752949300658217");
